...
set output 'usporedba-imagfree.png'
...
set multiplot
  ...
  set xrange[700:1200]
    ...
    plot \
         "D900.txt" u ($2*1000):9 w l ls 1  ti "Eksperiment", \
         "teorijaimp.txt" u 1:3 w l ls 2  ti "Analitički model za sinusnu raspodjelu struje",\
		 "imagnec.txt" u 1:2 w l ls 3 ti "Simulator: 4NEC2",\
		 "imagimp2mmsuz.txt" u 1:2 w l ls 4 ti "Simulator: Suzana"
