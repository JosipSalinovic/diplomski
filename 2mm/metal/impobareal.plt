...
set output 'usporedba-realfreemetal.png'
...
#set xtics 0,1,25
set multiplot
set title "Realna impedancija antene iznad metalne ploče"
  ...
  set xrange[700:1200]
    ...
    plot \
         "D900_M.txt" u ($2*1000):7 w l ls 1  ti "Eksperiment", \
		 "metalrealnec.txt" u 1:2 w l ls 3 ti "Simulator: 4NEC2",\
		 "suzrealm.txt" u ($1):($2) w l ls 4 ti "Simulator: Suzana"
